...
import static com.core.zlxd.zcore.App.getAppContext;
...
public final class SPUtils {
     ...
     *
     * @return the single {@link SPUtils} instanceTimeUtils.java
     */
    ...
    private SPUtils(final String spName) {
        sp = getAppContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = getAppContext().getSharedPreferences(spName, mode);
    }
